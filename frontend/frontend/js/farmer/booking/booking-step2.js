...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function getVehicleData() {
        ...
        for (let i = 1; i <= MAX_VEHICLES; i++) {
            ...
            const plateInput = card.querySelector(`input[name="plate${i}"]`);
            ...
            if (savedData) {
                ...
                if (savedData.vehicles && savedData.vehicles.length > 0) {
                    ...
                    if (firstVehicle) {
                        ...
                        const plate1 = document.querySelector('input[name="plate1"]');

                        if (select1) select1.value = firstVehicle.type;
                        if (plate1) plate1.value = firstVehicle.plate;
                    ...
                    for (let i = 1; i < savedData.vehicles.length; i++) {
                        ...
                        setTimeout(() => {
                            ...
                            const plate = document.querySelector(`input[name="plate${vehicleNum}"]`);
