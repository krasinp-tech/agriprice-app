/**
 * api-client.js
 * ไฟล์ที่เป็น "หัวใจ" ในการสื่อสารกับ Server
 * ทำหน้าที่เป็นตัวกลาง (Bridge) ในการเรียกข้อมูล (Fetch Data) จาก Backend ทั้งหมด
 * เช่น การ Login, การดึงโปรไฟล์, การส่งข้อมูลการจอง และการแชท
 */
(function () {
